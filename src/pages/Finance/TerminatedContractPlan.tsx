                            ...
                            <Table>
                                <TableHeader className="bg-mainbg/10">
                                    <TableRow>
                                        ...
                                        <TableHead className="text-maintx dark:text-white text-right">
                                            Сумма
                                        </TableHead>
                                        <TableHead className="text-maintx dark:text-white text-right">
                                            Оплачено
                                ...
                                <TableBody>
                                    {prices.map((p, idx) => {
                                        const priceStatus = getPriceStatusStyle(
                                            p.payment_status,
                                        );
                                        return (
                                        <TableRow
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                <Badge
                                                    variant="outline"
                                                    className={`text-xs whitespace-nowrap ${priceStatus.cls}`}
                                                >
...
const SummaryCard = ({
    ...
    const c = {
        blue: {
            ...
            sub: "text-blue-400 dark:text-blue-500",
        },
        green: {
            ...
            sub: "text-green-400 dark:text-green-500",
        },
        red: {
        ...
        yellow: {
            ...
            sub: "text-yellow-400 dark:text-yellow-500",
        },
        purple: {
